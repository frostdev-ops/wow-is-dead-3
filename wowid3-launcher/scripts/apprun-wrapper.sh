#!/bin/bash
# WOWID3 Launcher - AppImage AppRun Wrapper
# This script replaces the default AppRun to ensure Wayland compatibility
...
# Get the directory where this script is located (AppDir root)
APPDIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

# The actual binary is in usr/bin/wowid3-launcher
BINARY="$APPDIR/usr/bin/wowid3-launcher"
